...
// import { UserRole } from '../../../shared/models/loan-application';

// @Component({
//   selector: 'app-review-pinjaman',
//   standalone: true,
//   imports: [LoanQueueListComponent, LoanReviewDrawerComponent],
//   templateUrl: './review-pinjaman.html',
//   styleUrl: './review-pinjaman.css',
// })
// export class ReviewPinjaman extends ReviewQueueBase {
//   protected readonly role: UserRole = 'MARKETING';
//   protected readonly subtitle = 'Pengajuan menunggu review marketing';
// }
...
export class ReviewPinjaman extends ReviewQueueBase {
  protected readonly role = 'MARKETING' as const;
  protected readonly subtitle = 'Pengajuan menunggu review marketing';
}